export const data = {
  ...
  vanProfile: [
    ...
    {
      id: 7,
      thumbnailSrc: ["/assets/campervan/5/motorhome-2.jpg"],
      name: "xxxx",
      vanType: "caravan",
      sleep: 3,
      location: "adelaide",
    ...
    {
      id: 8,
      thumbnailSrc: ["/assets/campervan/4/motorhome-1.jpg"],
      name: "sdfst",
      vanType: "caravan",
      sleep: 3,
      location: "adelaide",
  ...
  highlights: [
    ...
    },
    {
      ...
      durations: "5 days",
      highlights: ["Red Bluff", "Turquoise Bay", "Nambung National Park"],
      content:
        "We loved our visit to The Pinnacles. It was a ‘desert meets sea’ experience. The Pinnacles are limestone formations within Nambung National Park. There are many theories of how they formed but some say they came from seashells.We took the 9km loop drive through the majestic pinnacles. There are many places to pull up the van and soak up the views where the desert meets the sea. We were surrounded by thousands of these rock formations rising from the yellow sand of the Pinnacles Desert.",
    },
    {
      id: 3,
