...
export const RequestPage = () => {
  ...
  const memberData = JSON.parse(
    localStorage.getItem("yumeCamp_member") as string
  );
  ...
  const diffDays =
    differenceInDays(resetDate[0].endDate, resetDate[0].startDate) + 1;
      ...
      <PageContainer>
        ...
        <RequestDetailContainer>
          <div className={"w-[600px] flex flex-col"}>
            ...
            <p>
              Cancel earlier than 10 days before the start of the booking and
              receive a full credit. Refunds available upon request (less any
              admin fees) and may take up to 30 days to process.
            </p>
            <p>
              Cancel earlier than 10 days before the start of the booking and
              receive a full credit. Refunds available upon request (less any
          ...
          <div
            className={`w-[350px] border-solid border border-gray-300 rounded-[3px] p-4`}
          >
            <BookingQuote
              price={price}
              diffDays={diffDays}
              onUpdateTotalFee={handleTotalFeeUpdate}
            />
          </div>
        </RequestDetailContainer>
      </PageContainer>
