...
export const Login = () => {
  ...
  const [loginRemandMsg, setLoginRemandMsg] = useState(
    localStorage.getItem("loginRemandMsg") || ""
  );
  ...
  return (
    <Layout>
      ...
      {loginRemandMsg && (
        <p className={"bg-pink-200 text-red-500 font-bold p-1 mb-1"}>
          {loginRemandMsg}
        </p>
      )}
      ...
      <Formlayout>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <Button
            theme="base"
            text="Log in"
            className="bg-primary hover:bg-transparent hover:text-primary hover:border-primary"
          />
        </Form>
        <hr />
        <p>
          Need an Account?{" "}
          <a href="/signup">
            <strong className="text-secondary">Sign Up</strong>
          </a>
        </p>
      </Formlayout>
